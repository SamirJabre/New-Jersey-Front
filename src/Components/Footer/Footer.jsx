  ...
  return (
    <footer className="w-full h-fit bg-[#101010] flex flex-col items-center justify-between py-5">
      <div className="w-full h-60 flex flex-col justify-between items-center">
        ...
        <p className="text-white font-inter text-xs text-center">
          Lebanon, Tripoli, Al-Mina, Next To OMT, 961 3 330 550
        </p>
        <a href="#" className="text-blue-600 text-xs font-inter">
        ...
        <div className="flex justify-between w-2/3 h-fit items-center">
          ...
          <a href="#">
            <img src={instagram} alt="" className="scale-75" />
          </a>
          <a href="#">
            <img src={x} alt="" className="scale-75" />
          </a>
          <a href="#">
            <img src={youtube} alt="" className="scale-75" />
          </a>
        </div>
      </div>
      <hr className="w-full h-1 m-5" style={{ borderColor: "gray" }} />

      <div className="h-fit w-full px-5 flex flex-wrap justify-between items-center">
        <div className="w-1/3 h-20 mb-8">
